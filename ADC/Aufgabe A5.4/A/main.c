...
void main(void) {
    ...
    static const uint16_t fix_vol_1 = 620;  // 2V=(3.3V/1023)*x -> x = (2V*1023)/3.3V 620
    static const uint16_t fix_vol_2 = 465;  // 1.5V=(3.3V/1023)*x -> x = (1.5V*1023)/3.3V 465
    
    for(;;)
    {
      if(ADC_RESULT() >= fix_vol_1)
        LATD = 0xFF;
      else if(ADC_RESULT() <= fix_vol_2)
        LATD = 0x00;
